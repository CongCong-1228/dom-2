...
jQuery('.test').find('.child').addClass('green').addClass('aaa').addClass('bbb'); //find


var x2 = jQuery('.red').parent();
console.log(x2);

var x3 = jQuery('.test').children();
console.log(x3);
...
//# sourceMappingURL=/main.77c5df9a.map